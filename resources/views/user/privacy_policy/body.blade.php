<div class="blog-text">
    ...
    <ul>
        ...
        <li>
            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                &quot;Our&quot; in this Agreement) refers to AGA Holidays.</p>
        </li>
        <li>
        ...
        <li>
            <p><strong>Website</strong> refers to AGA Holidays, accessible from <a href="https://www.agaholidays.com/"
                    rel="external nofollow noopener" target="_blank">https://www.agaholidays.com/</a></p>
        </li>
        <li>
    ...
    <ul>
        <li>
            <p>By email: info@agaholidays.com</p>
        </li>
        <li>
            <p>By visiting this page on our website: <a href="https://www.agaholidays.com/contact"
                    rel="external nofollow noopener" target="_blank">https://www.agaholidays.com/contact</a></p>
        </li>
    </ul>

    {{-- https://www.termsfeed.com/live/f24f8286-a005-4e84-af34-5126ecb62c6c --}}
</div>